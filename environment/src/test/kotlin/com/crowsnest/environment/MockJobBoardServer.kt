    ...
    private val server =
            embeddedServer(Netty, port = port) {
                        routing {
                            ...
                            // This maps the URL path /static to the classpath resource folder
                            // www/static
                            ...
                            // 4. Button Pagination Test Page (simulating JetBrains-style
                            // pagination)
                            get("/button-pagination") {
                                val html =
                                        """
                    <html>
                    <body>
                        <h1>Job List (Button Pagination)</h1>
                        <ul>
                            <li>Job A</li>
                        </ul>
                        <nav class="pagination">
                            <button aria-label="Previous page" class="pagination__previous">Prev</button>
                            <button id="next-btn" aria-label="Next page" class="pagination__next">Next</button>
                        </nav>
                    </body>
                    </html>
                """.trimIndent()
